...
ExternalProject_Add(bf-p4i
  ...
  DOWNLOAD_COMMAND tar -jxvf ${CMAKE_CURRENT_SOURCE_DIR}/${BF_PKG_DIR}/p4i/p4i.linux.tar.bz2
      -C ${CMAKE_INSTALL_PREFIX}/p4i --strip-components=1
  CONFIGURE_COMMAND ""
  BUILD_COMMAND ""
  INSTALL_COMMAND ln -sf ${CMAKE_INSTALL_PREFIX}/p4i/p4i ${CMAKE_INSTALL_PREFIX}/bin/p4i
)
