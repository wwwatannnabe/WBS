...
function(P4_BUILD_TARGET t arch target p4program)
  ...
  elseif (${target} STREQUAL "tofino2h")
    set(chiptype "tofino2")
  else()
    set(chiptype ${target})
  endif()
...
function(P4_BUILD t location)
  ...
  if (TOFINO2H)
    p4_build_target(${t} ${P4_tofino2_ARCHITECTURE} "tofino2h" ${CMAKE_CURRENT_SOURCE_DIR}/${location}/${t}/${t}.p4 ${input_rt_list})
  endif()
  if (TOFINO3)
...
function(P4_BUILD_PD t location)
  ...
  if (TOFINO2H)
    p4_build_pd_target(${t} ${P4_tofino2_ARCHITECTURE} "tofino2h" ${CMAKE_CURRENT_SOURCE_DIR}/${location}/${t}/${t}.p4)
  endif()
  if (TOFINO3)
